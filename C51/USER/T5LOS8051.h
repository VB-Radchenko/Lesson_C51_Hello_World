...
sfr SCON2           = 0x98;                     /*UART2控制接口*/
sfr SCON3           = 0x9B;                     /*UART3控制接口*/
sfr SBUF2           = 0x99;                     /*UART2收发缓冲区*/
sfr SBUF3           = 0x9C;                     /*UART3收发缓冲区*/
...
/* UART2 */
sbit SM0            = SCON2^7;                  /*方式选择1*/
sbit SM1            = SCON2^6;                  /*方式选择2*/
sbit SM2            = SCON2^5;                  /*多机通信控制*/
sbit REN0           = SCON2^4;                  /*串行接收允许*/
sbit TB80           = SCON2^3;                  /*欲发的第九位*/
sbit RB80           = SCON2^2;                  /*欲收的第九位*/
sbit TI2            = SCON2^1;                  /*发送中有无中断*/
sbit RI2            = SCON2^0;                  /*接收中有无中断*/
sfr SREL2H          = 0xBA;                     /*设置波特率，当ADCON为0x80时*/
sfr SREL2L          = 0xAA;

/* UART3 */

sfr SREL3H          = 0xBB;                     /*设置波特率*/
sfr SREL3L          = 0x9D;
...
sfr BODE4_DIV_H     = 0xD9;                     /*UART4波特率设置*/
sfr BODE4_DIV_L     = 0xE7;

/* UART5 */
sfr SCON5T          = 0xA7;                     /*UART5发送控制*/
sfr SCON5R          = 0xAB;                     /*UART5接收控制*/
sfr SBUF5_TX        = 0xAC;                     /*UART5发送数据接口*/
sfr SBUF5_RX        = 0xAD;                     /*UART5接收数据接口*/
sfr BODE5_DIV_H     = 0xAE;                     /*UART5波特率设置*/
